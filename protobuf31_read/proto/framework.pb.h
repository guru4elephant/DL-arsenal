...
const AttrType AttrType_MAX = BLOCKS;
...
class OpProto_Var : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:paddle.framework.proto.OpProto.Var) */ {
 public:
  ...
  bool has_reuse() const;
  void clear_reuse();
  static const int kReuseFieldNumber = 6;
  const ::std::string& reuse() const;
  void set_reuse(const ::std::string& value);
  void set_reuse(const char* value);
  void set_reuse(const char* value, size_t size);
  ::std::string* mutable_reuse();
  ::std::string* release_reuse();
  void set_allocated_reuse(::std::string* reuse);
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr reuse_;
  bool duplicable_;
  bool intermediate_;
  bool dispensable_;
  friend void  protobuf_InitDefaults_framework_2eproto_impl();
...
class VarType_ChannelDesc : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:paddle.framework.proto.VarType.ChannelDesc) */ {
 public:
  ...
  static const VarType_ChannelDesc* internal_default_instance();

  void Swap(VarType_ChannelDesc* other);

  // implements Message ----------------------------------------------

  inline VarType_ChannelDesc* New() const { return New(NULL); }
  ...
  void UnsafeMergeFrom(const VarType_ChannelDesc& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _arena_ptr_;
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<VarType_ChannelDesc> VarType_ChannelDesc_default_instance_;
...
// optional string reuse = 6;
inline bool OpProto_Var::has_reuse() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void OpProto_Var::set_has_reuse() {
  _has_bits_[0] |= 0x00000020u;
}
inline void OpProto_Var::clear_has_reuse() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void OpProto_Var::clear_reuse() {
  reuse_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_reuse();
}
inline const ::std::string& OpProto_Var::reuse() const {
...
inline void OpProto_Var::set_reuse(const ::std::string& value) {
  set_has_reuse();
...
inline void OpProto_Var::set_reuse(const char* value) {
  set_has_reuse();
...
inline void OpProto_Var::set_reuse(const char* value, size_t size) {
  set_has_reuse();
...
inline ::std::string* OpProto_Var::mutable_reuse() {
  set_has_reuse();
...
inline ::std::string* OpProto_Var::release_reuse() {
...
inline void OpProto_Var::set_allocated_reuse(::std::string* reuse) {
  if (reuse != NULL) {
    set_has_reuse();
  } else {
    clear_has_reuse();
